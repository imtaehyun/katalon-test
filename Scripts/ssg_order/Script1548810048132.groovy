...
'상품 페이지 이동'
WebUI.navigateToUrl('http://qa-emart.ssg.com/item/itemView.ssg?itemId=${itemId}&siteNo=6001&salestrNo=2034')

isValidToBuy = WebUI.verifyElementPresent(findTestObject('order/a__1'), 1)
...
if (isValidToBuy) {
    ...
    System.out.println('상품 상태 확인 필요')
}
